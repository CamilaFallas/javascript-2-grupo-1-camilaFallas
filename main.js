...
// 2. Y dependiendo la nota se agrega de manera automática una propiedad 
//nueva que se llama estado: cuyo valor sera de aprobado (nota > 70) o reprobado (nota < 70)

this.notaObtenida = function(curso, nota){
  ...
  this.cursosCursados.push(calificaciones);
}

const andy = new EstudianteConstructor('Andy', 'Smith', '1990-10-30', 'arq-0001', true, 'Historía del Arte', ['Historia del Arte I']);
andy.notaObtenida('Introducción a la pintura', 90);
console.log(andy);